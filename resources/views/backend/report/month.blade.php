...
@section('title-content')  التقرير الشهرى للاستعلامات - هاى تك للتقسيط @endsection
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block" style="font-family:'Cairo', sans-serif; font-size: large">التقرير الشهرى للاستعلامات</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" style="font-family:'Cairo', sans-serif; font-size: small">التقرير الشهرى للاستعلامات
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <b>اجمالى الاستعلامات لهذا الشهر : </b>  {{ count($orders) }} استعلام
                            </div>

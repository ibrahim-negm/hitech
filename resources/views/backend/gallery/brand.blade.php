    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block" style="font-family:'Cairo', sans-serif; font-size: large">الجاليرى</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.brand') }}" style="font-family:'Cairo', sans-serif; font-size: small">الجاليرى</a>
                            </li>
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content tx-size-sm">
                            <div class="modal-header pd-x-20" >
                                <h4 style="font-family:'Cairo', sans-serif; font-size: large"> أضافة ماركة عالمية</h4>
                            ...
                            <form action="{{ route('admin.store_brand') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body pd-20">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('brand_name') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp"
                                               placeholder="اسم الماركة العالمية" name="brand_name">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-info pd-x-20" > اضف ماركة عالمية</button>

                                    ...
                                    <div class="post card-container col-lg-3">
                                        <div class="item-box m-b10 blog-post blog-grid blog-rounded blog-effect1 dlab-info p-a20 border-1" @if($row->product_quantity <= 0) style="background-color: #fff5f8" @endif>
                                            ...
                                            <div class="item-info text-center text-black p-a10 ">
                                                ...
                                                <h6 class="item-title font-weight-300" style="font-size: 14px" ><a href="{{ route('products.in.brand',[$row->brand->id,$row->brand->brand_name]) }}">{{ $row->brand->brand_name }}</a></h6>
                                                @php
                                ...
                                <div class="dlab-accordion advanced-search toggle" id="accordion1">
                                        ...
                                        <div id="vendor" class="acod-body collapse show">
                                            <div class="acod-content">
                                                <div class="product-brand">
                                                    ...
                                                    <form action="{{ route('price.filter.brand',[$id,$nameOfFather]) }}" method="post" id="priceList">
                                                        @csrf
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="vendor" class="acod-body collapse show">
                                            <div class="acod-content">
                                                <div class="product-brand">
                                                    <form action="{{ route('brand.filter.brand',[$id,$nameOfFather]) }}" method="post" id="brandList">
                                                    @csrf
                                    ...
                                    <div class="panel">
                                        <?php
                                            $all_products = \App\Models\Admin\Product::where('brand_id',$id)->where('status',1)->
                                                where('approved',1)->get();
                                        $brands_tags = array();
                                        foreach ($all_products as $row ){
                                            foreach( explode(',',$row->product_tags) as $tags){
                                                if(!in_array($tags,$brands_tags)){
                                                $brands_tags[] = $tags;
                                                }
                                            }
                                        }
                                        ...
                                        <div id="tags" class="acod-body collapse">
                                            <div class="acod-content">
                                                <div class="widget_tag_cloud radius">
                                                       ...
                                                       <a href="{{route('tag.brand.products.filter',[$id,$nameOfFather,$tag])}}">{{$tag}}</a>
                                                       @endforeach

                                ...
                                <div class="dlab-accordion advanced-search toggle" id="accordion1">
                                        ...
                                        <div id="vendor" class="acod-body collapse show">
                                            <div class="acod-content">
                                                <div class="product-brand">
                                                    ...
                                                    <form action="{{ route('price.filter',[$id,$nameOfFather]) }}" method="post" id="priceList">
                                                        @csrf
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="vendor" class="acod-body collapse show">
                                            <div class="acod-content">
                                                <div class="product-brand">
                                                    <form action="{{ route('brand.filter',[$id,$nameOfFather]) }}" method="post" id="brandList">
                                                    @csrf
                                    ...
                                    <div class="panel">
                                        <?php
                                            $all_products = \App\Models\Admin\Product::where('service_id',$id)->where('status',1)->
                                                where('approved',1)->get();
                                        $products_tags = array();
                                        foreach ($all_products as $row ){
                                            foreach( explode(',',$row->product_tags) as $tags){
                                                if(!in_array($tags,$products_tags)){
                                                    $products_tags[] = $tags;
                                                }
                                        ...
                                        <div id="tags" class="acod-body collapse">
                                            <div class="acod-content">
                                                <div class="widget_tag_cloud radius">
                                                       ...
                                                       <a href="{{route('tag.service.products.filter',[$id,$nameOfFather,$tag])}}">{{$tag}}</a>
                                                       @endforeach

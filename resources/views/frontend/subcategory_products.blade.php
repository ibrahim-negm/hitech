                                ...
                                <div class="dlab-accordion advanced-search toggle" id="accordion1">
                                        ...
                                        <div class="acod-head">
                                            <h5 class="acod-title">
                                                <a data-toggle="collapse" href="#categories">
                                                      الفئات الفرعية من     {{ $nameOfFather }}
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="categories" class="acod-body collapse show">
                                            <div class="acod-content">
                                                <div class="widget widget_services">
                                                    <ul>
                                                        <?php
                                                            $subsubcategories = \App\Models\Admin\SubSubCategory::where('subcategory_id',$id)->get();
                                                        ?>
                                        ...
                                        <div id="vendor" class="acod-body collapse show">
                                            <div class="acod-content">
                                                <div class="product-brand">
                                                    ...
                                                    <form action="{{ route('price.filter.subcategory',[$id,$nameOfFather]) }}" method="post" id="priceList">
                                                        @csrf
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="vendor" class="acod-body collapse show">
                                            <div class="acod-content">
                                                <div class="product-brand">
                                                    <form action="{{ route('brand.filter.subcategory',[$id,$nameOfFather]) }}" method="post" id="brandList">
                                                    @csrf
                                    ...
                                    <div class="panel">
                                        <?php
                                            $all_products = \App\Models\Admin\Product::where('subcategory_id',$id)->where('status',1)->
                                                where('approved',1)->get();
                                        $subcategory_tags = array();
                                        foreach ($all_products as $row ){
                                            foreach( explode(',',$row->product_tags) as $tags){
                                                if(!in_array($tags,$subcategory_tags)){
                                                    $subcategory_tags[] = $tags;
                                                }
                                        ...
                                        <div id="tags" class="acod-body collapse">
                                            <div class="acod-content">
                                                <div class="widget_tag_cloud radius">
                                                       @foreach($subcategory_tags as $tag)
                                                       <a href="{{route('tag.subcategory.products.filter',[$id,$nameOfFather,$tag])}}">{{$tag}}</a>
                                                       @endforeach
